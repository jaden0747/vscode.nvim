...
theme.set_highlights = function(opts)
    ...
    hl(0, '@variable.parameter', { fg = c.vscGray, bg = 'NONE' })
    hl(0, '@variable.parameter.reference', { fg = c.vscDarkBlue, bg = 'NONE' })
    hl(0, '@variable.member', { fg = c.vscLightPink, bg = 'NONE' })
    hl(0, '@property', { fg = c.vscLightPink, bg = 'NONE' })
    ...
    hl(0, '@lsp.type.macro', { fg = c.vscPink, bg = 'NONE' })
    ...
    hl(0, '@lsp.typemod.variable.globalScope', { fg = c.vscLightGreen, bg = 'NONE' })
    hl(0, '@lsp.type.member', { link = '@variable.member' })
    hl(0, '@lsp.type.property', { link = '@variable.member' })
